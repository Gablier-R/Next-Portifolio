                ...
                <div class="grid gap-4 mx-4 sm:grid-cols-12">
                    <div class="col-span-12 sm:col-span-3">
                        ...
                        <h3 class=" ">Minha <span className="text-gray-100 dark:box-decoration-slice bg-gradient-to-r from-purple-900 to-purple-600">educação</span> </h3>
                            <span class="mb-1 text-sm font-normal leading-none text-gray-500 dark:text-gray-400">Onde estudei</span>
                        </div>
                    </div>
                    <div class="relative col-span-12 px-4 space-y-6 sm:col-span-9">
                        <div class="col-span-12 space-y-12 relative px-4 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:bg-gray-500">
                            <div class="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-violet-600">
                                <time class="mb-1 text-sm font-normal leading-none text-gray-400">Agosto 2017 - Abril 2019</time>
                            ...
                            <div class="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-violet-600">
                                <time class="mb-1 text-sm font-normal leading-none text-gray-400">Fevereiro 2019 <span class="bg-purple-600 text-gray-200 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-purple-600 dark:text-gray-200 ml-3">Now</span></time>
                            ...
                            <div class="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-violet-600">
                                <time class="mb-1 text-sm font-normal leading-none text-gray-400"> <span class="bg-purple-600 text-gray-200 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-purple-600 dark:text-gray-200 ml-3">Now</span></time>
